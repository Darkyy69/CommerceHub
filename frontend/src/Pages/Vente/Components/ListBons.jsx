...
const ListBons = () => {
  ...
  React.useEffect(() => {
    const filteredBon = bon?.filter((item) => {
      ...
      const startDate = new Date(dateFilter.le);
      const endDate = new Date(dateFilter.au);
  ...
  return (
    <div className="flex flex-col justify-between fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 w-10/12 h-4/5 bg-gray-100 rounded-lg shadow-lg p-6">
