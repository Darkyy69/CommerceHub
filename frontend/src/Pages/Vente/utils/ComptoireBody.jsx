        ...
        <div className="flex flex-row justify-center items-center gap-2">
          <div className="flex flex-row justify-start items-center gap-1">
            ...
            <input
              name="Prix"
              id=""
              className="border border-gray-300 h-8 ml-14"
            ></input>
          </div>
          <div className="flex flex-row justify-start items-center gap-1">
            ...
            <input
              name="Id"
              id=""
              className="border border-gray-400 h-8 w-10"
            ></input>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-row justify-between items-center w-full h-fit m-3">
      <div className="flex flex-col h-full items-start justify-center gap-5  bg-blue-500 p-3 ml-3">
        ...
        <div className="flex flex-row justify-center items-center gap-2">
          ...
          <input
            ...
            name="prix"
            onChange={HandelInput}
            value={selectedArticle ? selectedArticle.P_vente : input.prix}
          />
        </div>
      </div>
      ...
      <div
        ...
        className=" w-1/2 h-full text-right bg-black mr-3"
      >
